...
export default function CardSection() {
  ...
  return (
    <section className={`${styles.CardSection} ${manrope.className}`} onMouseEnter={handleCard} onTouchStart={handleCard}>
        {cardPop && (
            <>
                <motion.h2
                    initial={{ opacity: 0 }} 
                ...
                <div className={styles.card_container} onMouseEnter={handleCardTwo} onTouchStart={handleCardTwo}>
                    {cardPopTwo && (
                        <>
        ...
        <div className={styles.map} onMouseEnter={handleCardThree} onTouchStart={handleCardThree}>
            {cardPopThree && (
                <>
                    <motion.div 
